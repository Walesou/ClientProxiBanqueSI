...
public class VirementServlet extends MereServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// On récupère tous les clients de la banque.
		List<Client> clients = service.getTousLesClients();
		/**
		 * Pour chaque client, on récupère ses comptes et on les ajoute à l’objet. C’est
		 * fastidieux, mais c’est la joie de la persistance « à la mano ».
		 */
		...
		// Oui, c’est pas optimal ; mais le conseiller a au maximum dix clients,
		// donc ça reste un choix valable.
		List<Client> mesClients = service.getClientsByConseillerAuthName(request.getUserPrincipal().getName());
		// Pour chaque client, on récupère ses comptes et on les ajoute à
		// l’objet.
		// C’est fastidieux, mais c’est la joie de la persistance « à la
		// mano ».
